  ...
  return (
    ...
    >
      ...
      <motion.h3
        ...
        className="text-gray-400 font-Header text-sm md:text-lg sm:text-md mt-10 tracking-wider "
      >
        I&apos;m a <span className="text-AAsecondary">Full Stack Developer</span> with strong{" "}
        ...
        and <span className="text-AAsecondary">back-end development</span>, along with a curiosity for leveraging
        <span className="text-AAsecondary">AI-driven applications</span>.
        <br className="3xl:block hidden" />. I enjoy solving challenging projects that
        drive <span className="text-AAsecondary"> innovation</span> and deliver high-quality results.
        <br className="3xl:block hidden" /> My experience in <span className="text-AAsecondary">collaborating with development teams</span>
        has strengthened my ability to work effectively with others and translate ideas into functional solutions.
