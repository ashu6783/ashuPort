            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6 z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-left">
                  At <span className="text-AAsecondary">MedSynth</span>, I developed an innovative web application leveraging
                  ...
                  This AI-powered platform enables researchers to rapidly design molecular structures, explore properties,
                  and identify therapeutic compounds using cutting-edge computational chemistry and informatics technologies.
                  I took help of AI tools for understanding the structure of the molecule and its properties and implement it in the web application.
                  Originally it was a part of the 24 hrs hackathon project.
