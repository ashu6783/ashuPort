          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0 md:order-2">
              <div className="relative w-full h-full">
                ...
                <Img src={"/medsynth.png"} alt={"Project Screen shot"} className={`w-full h-full`} />
              </div>
            </div>
            ...
            >
              <div className="flex flex-col space-y-1  z-10">
                ...
                <a href="https://med-synth.vercel.app/" target="_blank" rel="noopener noreferrer">
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
                    Drug Research Plateform
                  </span>
                </a>
              </div>
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-left ">
                  At <span className="text-AAsecondary">MedSynth</span>, I developed an innovative web application using leveraging
              ...
              <div className="z-10 flex fle-row space-x-5 ">
                {/* <GithubIcon link="https://github.com/ashu6783/MedSynth" /> */}
                <a href="https://med-synth.vercel.app/" target={"_blank"} rel="noreferrer">
