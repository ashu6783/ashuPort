...
const IconsData = [
  { href: "https://github.com/ashu6783", Icon: GithubIcon },
  { href: "https://www.linkedin.com/in/ashutosh-gaurav-2abba7215/", Icon: LinkedinIcon },
  { href: "https://www.instagram.com/_ashu91/", Icon: InstagramIcon },
];

export default function Fotter(props: { githubUrl: string; hideSocialsInDesktop: boolean }) {
  return (
    <div className=" flex flex-col justify-center items-center py-8 space-y-4">
      <div className={`flex flex-row space-x-8 ${props.hideSocialsInDesktop ? "" : ""}`}>
